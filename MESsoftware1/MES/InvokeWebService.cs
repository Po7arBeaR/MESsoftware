...
namespace DynamicInvoke
{
    ...
    public class WSHelper
    {
        ...
        /// <returns></returns>
        public  object InvokeWebService(string url, string methodname, SoapHeader soapHeader, object[] args)
        {
        ...
        /// < param name="args">参数< /param> 
        /// < returns>< /returns> 
        public  object InvokeWebService(string url, string classname, string methodname, SoapHeader soapHeader, object[] args)
        {
          //  Console.WriteLine("intoWebService");
            ...
            try
            {
                ...
                ((System.Web.Services.Protocols.WebClientProtocol)(obj)).Timeout = 2;//毫秒
                #region 设置SoapHeader
            ...
            catch (Exception ex)
            {
                ...
                if (ex.InnerException.Message == "操作超时")
                {

                    if (a < 3)
                    {
                        Console.WriteLine($"timeout{a}");
                        a++;
                        InvokeWebService(url, classname, methodname, soapHeader, args);
                    }
